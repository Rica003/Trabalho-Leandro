...
<body>
    ...
    <main>
        ...
        <section id="anime-list">
            ...
            <table>
                <tr>
                    <td><img src="image/Agro1.jpg" alt="Anime 1"></td>
                    <td><img src="image/Agro2.jpg" alt="Anime 2"></td>
                    <td><img src="image/Agro3.jpg" alt="Anime 3"></td>
                </tr>
            </table>
        </section>
        <section id="outro">
    ...
    <footer>
        <a href="Propriedades/propriedades.php">Cadastro de Propriedades</a>
        <a href="Culturas/culturas.php">Cadastro de Culturas da sua Fazenda</a>
        <a href="Equipamentos/equipamentos.php">Cadastro dos Equipamentos da sua Fazenda</a>
    </footer>
</body>
</html>